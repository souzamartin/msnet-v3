    ...
    <Container>
      <Stack direction={{ xs: "column", sm: "row"}} spacing={3}>
        <Typography variant="body">
          ...
          <br/>
          <br/>
          In addition to my services as a specialist Polaroid photographer, I offer introductory instruction in the medium through  Polaroid 101 workshops and in private sessions. I also provide vintage Polaroid cameras for rental, including whatever level of guidance and support you need to use them.
          <br/>
          <br/>
          I am also a contributor and Editor at <Link
